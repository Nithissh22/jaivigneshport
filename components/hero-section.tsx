  ...
  return (
    <div ref={containerRef} className="relative min-h-screen overflow-hidden bg-background" id="home">
      ...
      <AnimatePresence>
        {!isLoaded && (
          <motion.div
            className="fixed inset-0 bg-background z-[200] flex flex-col items-center justify-center overflow-hidden"
            exit={{ 
              opacity: 0,
              scale: 1.1,
              filter: "blur(10px)",
          ...
          >
            ...
            >
              <div className="relative mb-12 flex items-center justify-center">
                ...
                />
                <motion.div 
                  className="absolute w-56 h-56 md:w-72 md:h-72 border border-accent/20 rounded-full border-dashed"
                  animate={{ rotate: -360 }}
                ...
                <h1 className="text-7xl md:text-9xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white to-white/50 text-glow-green tracking-tighter relative z-10">
                  JV
                </h1>
              </div>
              ...
              <div className="flex flex-col items-center gap-6">
                <motion.div 
                  className="text-xs md:text-sm tracking-[0.5em] text-accent uppercase font-bold"
                ...
                <div className="relative w-64 md:w-96 h-1.5 bg-white/5 rounded-full overflow-hidden backdrop-blur-sm shadow-[0_0_15px_rgba(34,197,94,0.2)]">
                  <motion.div
                ...
                <div className="flex items-end gap-1 font-mono">
                  <span className="text-3xl md:text-5xl font-black text-white tracking-tighter" style={{ textShadow: "0 0 20px rgba(255,255,255,0.5)" }}>
                    {loadingProgress}
                  </span>
                  <span className="text-primary mb-1 md:mb-2 text-lg md:text-xl font-bold">%</span>
                </div>
              </div>
            </motion.div>
          </motion.div>
